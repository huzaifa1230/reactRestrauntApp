    ...
    <div>
      <div className="container my-24 mx-auto md:px-6">
        <section className="mb-16 text-center">
          <h2 className="mb-12 text-3xl font-bold text-black">Testimonials</h2>
            ...
            <div className="mb-6 lg:mb-0">
              <div className="block rounded-lg bg-black shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] dark:bg-neutral-700">
                ...
                <div className="p-6">
                  ...
                  <p>
                    Delightful flavors danced on my palate, each bite a symphony
                    of taste and texture, leaving me craving for more
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="mb-6 lg:mb-0">
              <div className="block rounded-lg bg-black shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] dark:bg-neutral-700">
                ...
                <div className="p-6">
                  ...
                  <p>
                    The cozy ambiance paired with delectable dishes created a
                    memorable dining affair, setting the bar high for culinary
                    excellence.
                  </p>
                </div>
              </div>
            ...
            <div className="">
              <div className="block rounded-lg bg-black shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] dark:bg-neutral-700">
                ...
                <div className="p-6">
                  ...
                  <p>
                    The impeccable presentation of the dishes was surpassed only
                    by their exquisite taste, a testament to the chef's skill
                    and passion.
                  </p>
                </div>
              </div>
